			...
			<nav id="nav">
				<ul>
					...
					<li><a href="<c:url value='/wedding/wedBrochure'/>">WEDDING</a>
						<ul>
							<li><a href="<c:url value='/wedding/wedBrochure'/>">WEDDING
									HALL</a></li>
							<li><a href="<c:url value='/wedRes/wedResList'/>">WEDDING
									BUFFET</a></li>
							<li><a href="<c:url value='/wedCs/wedCsList'/>">COLSULTING</a></li>
							<li><a href="<c:url value='/wedRv/wedRvList'/>">RESERVATION</a>
		...
		<div class="container">
			<section>
				...
				<a href="<c:url value='../wedRes/wedResList'/>">WEDDING
					RESTAURANT</a><br /> <a href="<c:url value='../wedCs/wedCsList'/>">웨딩
					예약 문의</a><br /> <a href="<c:url value='../wedRv/wedRvList'/>">웨딩
					최종 예약</a><br />
