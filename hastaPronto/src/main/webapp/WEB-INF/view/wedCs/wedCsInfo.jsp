				...
				<div class="container">
					<section>
						...
						<table border="1">
							...
							<tr>
								<th>성명</th>
								<td>${list.wedCosName}</td>
							</tr>
							<tr>
								<th>이메일</th>
								<td>${list.wedCosEmail}</td>
							</tr>
							<tr>
								<th>연락처</th>
								<td>${list.wedCosPh}</td>
							...
							<tr>
								<th>기타 문의사항</th>
								<td>${list.wedCosContent}</td>
							</tr>
						</table>
						<a href="wedCsModify?wedCosNo=${list.wedCosNo}">수정</a> <a href="#"
							onclick="return wedCsDel(${list.wedCosNo})">삭제</a>
